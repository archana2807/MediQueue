      ...
      {hasSearched && (
        <div className="pt-1">
          {patientFound ? (
            ...
            <div className="flex items-center gap-2 rounded-lg bg-teal-500/10 border border-teal-500/20 px-3 py-2 text-xs font-medium text-teal-600 dark:text-teal-400">
